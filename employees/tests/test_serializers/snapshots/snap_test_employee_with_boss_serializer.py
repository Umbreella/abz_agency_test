...
snapshots['EmployeeWithBossSerializerTestCase::test_Should_SpecificFormatForEachField 1'] = '''EmployeeWithBossSerializer():
    ...
    boss = EmployeeSerializer(read_only=True):
        ...
        middle_name = CharField(help_text='Employee middle name', max_length=255, required=False)
        last_name = CharField(help_text='Employee last name', max_length=255, required=False)
    boss_id = PrimaryKeyRelatedField(allow_null=True, queryset=<QuerySet []>, source='boss', write_only=True)'''
